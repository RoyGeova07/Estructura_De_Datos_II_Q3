...
struct NodoB
{
    ...
    int cantidad_claves;
    bool hoja;
    NodoB*hijos[ORDEN];//nueva variable de tipo nodo, para la raiz cuando se divide 

    NodoB()
    {

        cantidad_claves=2;// osea [7,10] una clave
        hoja=true;
        claves[0]=7;//el arbol empieza con una clave
        claves[1]=10;

        //con este for ayuda  
        for(int i=0;i<ORDEN;i++)hijos[i]=nullptr;
